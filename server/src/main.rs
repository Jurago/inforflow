...
fn handle_client(mut stream: TcpStream) {
    ...
    let response = if path.starts_with("/static/") {
        ...
        let (html, ct) = match path {
            ...
            "/cdn/detail" => (pages::render_cdn_detail(), "text/html; charset=utf-8"),
            "/peers" => (pages::render_peers(), "text/html; charset=utf-8"),
            "/peers/detail" => (pages::render_peers_detail(), "text/html; charset=utf-8"),
            "/asn" => (pages::render_asn(), "text/html; charset=utf-8"),
            "/asn/detail" => (pages::render_asn_detail(), "text/html; charset=utf-8"),
            "/streaming" => (pages::render_streaming(), "text/html; charset=utf-8"),
            "/streaming/detail" => (pages::render_streaming_detail(), "text/html; charset=utf-8"),
            "/router" => (pages::render_router(), "text/html; charset=utf-8"),
            "/router/detail" => (pages::render_router_detail(), "text/html; charset=utf-8"),
